...
ONEDU_EMAIL_RETRY_COUNT = env_int('ONEDU_EMAIL_RETRY_COUNT', 3)
ONEDU_EMAIL_RETRY_DELAY_SECONDS = env_float('ONEDU_EMAIL_RETRY_DELAY_SECONDS', 10.0)
ONEDU_EMAIL_ASYNC = env_bool('ONEDU_EMAIL_ASYNC', not DEBUG)
...
ONEDU_NOTIFY_ACCOUNT_WITHDRAWAL_REQUEST = env_bool('ONEDU_NOTIFY_ACCOUNT_WITHDRAWAL_REQUEST', True)
